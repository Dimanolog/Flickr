package com.github.dimanolog.flickr.ui.customview;
...
public class ImageViewWithZoom extends android.support.v7.widget.AppCompatImageView {
    ...
    public ImageViewWithZoom(Context context, AttributeSet attr, int defStyle) {
    ...
    @Override
    public void setOnLongClickListener(OnLongClickListener pListener) {
        attacher.setOnLongClickListener(pListener);
    }
